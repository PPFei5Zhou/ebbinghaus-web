...
export default {
  'POST /api/library': (req: Request, res: Response) => {
    res.status(200).send({
      ...
      "libraryName": "王社社提清入",
      "libraryDescription": "直体看新容定物江着生张则委即器基。南比空记易江际始断问样划改样低。手空物象压机易话话离济以等众过。面给定理音被她却感治价划以干白。用具件记斯技加规须关四满。江化育例近给公意整关系立任时上。",
  ...
  'PUT /api/library/:id': (req: Request, res: Response) => {
    res.status(200).send({
      ...
      "libraryName": "走家业",
      "libraryDescription": "酸斗必或节公然华期几八斗见。影响教听海分但行中军表片没马半局。认名西过展于准者装气再子打置。么上最往空都快我作断了属任说事。只命必少光领它行该直管当油将第。",
        ...
        "list": [
          {
            ...
            "libraryName": "市示意度四线",
            "libraryDescription": "五属很压传族已容会特别等交将始原作。长美前然选者府火却十人四则品。界断采断段写律因光南也两。重点眼联非真们先量连光商它片分上住。家导列保照水红所老同持维半合热相七。",
            "libraryParentId": "",
          ...
          },
          {
            ...
            "libraryName": "见合行许性",
            "libraryDescription": "清维式没都路热划连无且之然用。回段形无持时处即局拉平身思。想一发规阶什小务形极政口色示并。交高多小意管据业看清办连的米。活以多府回率红究时积志便治这或带。品月十民开越矿般往书布电别铁六。",
            "libraryParentId": "",
          ...
          },
          {
            ...
            "libraryName": "半什国传电",
            "libraryDescription": "厂厂龙十拉大全流土及分精八院王算。单光月前空劳龙高律器长便一满究。出越思要列素几国论本重公人亲。交八拉听对议劳但可次性样。",
            "libraryParentId": "",
          ...
          },
          {
            ...
            "libraryName": "养格非通过识",
            "libraryDescription": "查动八由事百府不重对他气八带前。铁年低切民条指术争住为究。看物场队国容原张日们四电声来团强建。则族往切民集铁美养快力并比如国解花相。总准物金革克织连则支心革结采线或机。",
          ...
          },
          {
            ...
            "libraryName": "可准确无建建则",
            "libraryDescription": "内什开美细动加反可称交他例。法口平日头国复东用并论品。地指六较划因切手统圆而接华实务它民。生着了政十场万华提收派全强然林声七史。马只次保术一展决取因北酸高场验术技委。",
            "libraryParentId": "",
          ...
          },
          {
            ...
            "libraryName": "根业料消共多",
            "libraryDescription": "称存你群照论物社九当变被决必知运统。专有性量铁划相建六开研确为系。加头周用使她油料家教主身当眼她。",
            "libraryParentId": "",
          ...
          },
          {
            ...
            "libraryName": "车六不观式及没",
            "libraryDescription": "常律志业问线说都三关新广积指备不。三战道点战八究东对维观场相度。看机指图果面教的其劳取记团选且拉。一带车斗九龙打林路造重国志增起题海。",
            "libraryParentId": "",
          ...
          },
          {
            ...
            "libraryName": "许般文清",
            "libraryDescription": "构利拉日高参国断加而群石改。反三光打同适果两须号级后群住果利。至满步斗意实已安平平内心区作列。物权连属界十量员动特心效局建王。公步来行量八情价持复或集色里土。同土太见少观理是党具为但写大数亲。",
            "libraryParentId": "",
          ...
          },
          {
            ...
            "libraryName": "名六根适消进型",
            "libraryDescription": "南光全压打大义知西引安一究省地据数写。政走建教音头联只际安更更以步。是因布持体求重论价业天越江五即。",
            "libraryParentId": "",
        ...
        "list": [
          {
            ...
            "libraryName": "观治断连",
            "libraryDescription": "定来事头增给者青即天相精果看热维。象这口取头步酸造作风率米叫素金。石化入局多直度角学问便南子划代原。好级很文开六石只等影较研。次员起组问土张张许系却代。",
            "libraryParentId": "",
          ...
          },
          {
            ...
            "libraryName": "米层什毛问选",
            "libraryDescription": "代受立电节最机量划看走保间运。米何才眼选后发大事全能主门级识平易。花六议办你千受管类做与命色查。角半为由组存往色千农离写离。候影广动就交处儿然儿手人又情交及。",
            "libraryParentId": "",
          ...
          },
          {
            ...
            "libraryName": "选统适观干酸县",
            "libraryDescription": "会但有况将子许叫车使验经。展家历查西采受程理日布形做合。叫效究国组理育好率林及个地需东都。而为即说统的再易受路样根式发许。专学风保列山由者向起道易育资省立。号议市价再想存时律发业响现志听起门特。离真县历就而广群据解了问和运起民务。",
            "libraryParentId": "",
          ...
          },
          {
            ...
            "libraryName": "长变高拉",
            "libraryDescription": "流二己群标约验示头完认约。性土组统原采严素比标元小白九华。已只起都值情斗五什调那它单本军天会。合下品应是七她江号志件进相即算。",
          ...
          },
          {
            ...
            "updateDate": "2022-03-18 15:52:27",
            "libraryName": "义分种物难七些",
            "libraryDescription": "传红收运亲流你红感条少型给历阶。变毛此走基本增千基革土活热物民北。积七式元但期应色开识门明。样效选商事点石经容度山江科现区些。那克料称角个声往离电派号装需美斗。他入机打越报步工研我场况决其式两然什。",
          ...
          },
          {
            ...
            "libraryName": "听然严等",
            "libraryDescription": "需济效记期论基响京道油要等。两我许列任转片拉局厂离做方酸业。便心此到效局车速片力二外张义。者手感律共王市论办社成习线调自天术平。电团往查变给往观完起在计亲自六。民高者议后向个往车况业和从发几查代。共除系连变规质商成后走出飞。",
          ...
          },
          {
            ...
            "libraryName": "般果大业区一",
            "libraryDescription": "市社比八白张般火明很老接满列安管组。果这号入低圆容气阶门离交值级消领。联消代火级空效内他阶品己二人日单任育。开设还取周与则清需及机低住做与。及价打照定半现律计经之非表积根使。",
            "libraryParentId": "0818cc2e-536c-4400-9e08-f91ecebbd967",
            "libraryOwnerId": "7F3632ef-d7Dc-5DFe-45Ac-4F4cFD8E7aD5"
          }
        ]
        ...
        "list": [
          {
            ...
            "libraryName": "小斗始治",
            "libraryDescription": "包价大然约与历改光去学热还类约。看常五解价比放定江什世用精道。已值下基增越水音做议调队维形号连。果省日或较照程示大易米变还。影持电九形周应政拉叫越属。",
            "libraryParentId": "0818cc2e-536c-4400-9e08-f91ecebbd967",
            "libraryOwnerId": "7F3632ef-d7Dc-5DFe-45Ac-4F4cFD8E7aD5"
          },
          {
            ...
            "libraryName": "务你战院共",
            "libraryDescription": "子毛技确还调角些步极厂列叫金党百。层种周公参太系术土务高照党观出圆进红。长构进还般感七热格除一太太此特。观该选石志眼边因报装按社什元西。千划区种细米部信观方深据共转府眼。",
          ...
          },
          {
            ...
            "libraryName": "军正导花",
            "libraryDescription": "称交备决情法标没安二和广。速类习上团领可己子们始适义务流取分建。布知工片江使期办产话标部极主又北百。",
            "libraryParentId": "1c8fa5a2-a843-409a-a0d8-5c54784eb774",
            "libraryOwnerId": "c53bA5B3-f286-2eBf-8A7E-2B7E7Aff1b2A"
          },
          {
            ...
            "libraryName": "走长圆多",
            "libraryDescription": "规民目则养万集五个史到色。圆口际深治总般空金实油几。律林却用色酸清确件具场百算治解反你。使华自改手西代须基维志手命。元流八改传带专强外界眼热名目则新种。阶基过如决局次江周何族因门性厂话。约效军边马口联却存子使再增参都。",
          ...
          },
          {
            ...
            "libraryName": "起率历却回族",
            "libraryDescription": "局置本感连心对利切工信速。算由式战且如手调于度放器立设内向。热斯系率族走万手角代取十料义始取。林称人反织积育提划亲定单水。约利主满声第白角五类七气须看系备料。",
            "libraryParentId": "2219df67-01bf-4b52-81aa-17115b1df1f7",
            "libraryOwnerId": "2333dbED-5EA8-7C7B-BBe5-cA3780b33298"
          },
          {
